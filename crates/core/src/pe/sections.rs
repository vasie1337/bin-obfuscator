...
impl PEContext {
    pub fn create_executable_section(
        &mut self,
        name: &str,
        bytes: &[u8],
    ...
    fn create_section(
        ...
        let (
            ...
            let optional_header = pe.header.optional_header.ok_or("Missing optional header")?;
        ...
        let (
            ...
            last_virtual_size,
            last_pointer_to_raw_data,
            last_size_of_raw_data,
        ) = last_section_info;
